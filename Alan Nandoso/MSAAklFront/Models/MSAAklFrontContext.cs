...
namespace MSAAklFront.Models
{
    public class MSAAklFrontContext : DbContext
    {
        ...
        public class MyConfiguration : DbMigrationsConfiguration<MSAAklFrontContext>
        {
            ...
            protected override void Seed(MSAAklFrontContext context)
            {
        ...
        public System.Data.Entity.DbSet<MSAAklFront.Models.Comment> Comments { get; set; }

        public System.Data.Entity.DbSet<MSAAklFront.Models.Reply> Replies { get; set; }
    }
}
